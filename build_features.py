...
OUTPUT_FILE = "account_features.csv"
...
def main():
    ...
    print()
    print("Median values by label (sanity check):")
    print(features.groupby("label")[["pass_through_ratio", "velocity_hours", "in_degree"]].median())
